<?php 
$pageTitle = "Loïc Parent • Affiche Retour vers le futur";
include( 'header.php' );
?>

<h1 class="projectTitle-1 title2">Affichre Retour vers le futur</h1>
<div id="content" class="content">
	<section class="infoProject">
		...
		<div class="description descCenter">
			<a class="image-popup-no-margins" href="./img/btf-1.jpg">
				<img src="./img/btf-1.jpg" alt="Affiche Retour vers le futur">
			</a>
		</div>
	</section>
</div>
