...
<head>
	<meta charset="UTF-8">
	<title>Journal de bord stage • semaine 12</title>
...
<body>
	...
	<h1 class="projectTitle-1 title2">Stage - Semaine 12</h1>
	<div class="centerZone jdbStageDay jdbStageDay--lun jour1">
		<h2 class="jdbStage__subtitle">JOUR 56 - 18/04</h2>
		
	</div>

	<div class="centerZone jdbStageDay jdbStageDay--mar jour2">
		<h2 class="jdbStage__subtitle">JOUR 57 - 19/04</h2>
		
	</div>

	<div class="centerZone jdbStageDay jdbStageDay--mer jour3">
		<h2 class="jdbStage__subtitle">JOUR 58 - 20/04</h2>
		
	</div>

	<div class="centerZone jdbStageDay jdbStageDay--jeu jour4">
		<h2 class="jdbStage__subtitle">JOUR 59 - 21/04</h2>
		
	</div>

	<div class="centerZone jdbStageDay jdbStageDay--ven jour5">
		<h2 class="jdbStage__subtitle">JOUR 60 - 22/04</h2>
	...
	<div class="centerZone">
		<nav class="jdbStage__nav">
			...
			<a href="./semaine11.php">Semaine précédente</a><a href="./sommaire.php">Sommaire</a>
		</nav>
	</div>
